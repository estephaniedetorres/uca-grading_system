...
<aside id="sidebar" class="sidebar fixed inset-y-0 left-0 w-64 bg-black text-white flex flex-col z-50 lg:translate-x-0">
    ...
    <div class="p-5 border-b border-neutral-800">
        <div class="flex items-center justify-between">
            ...
            <div>
                ...
                <p class="text-xs text-neutral-400">Dean Portal<?= $deptCodeLabel ? ' — ' . htmlspecialchars($deptCodeLabel) : '' ?></p>
            </div>
        </div>
    ...
    <nav class="flex-1 p-4 space-y-1 overflow-y-auto">
        <a href="/dean/dashboard.php" class="sidebar-link flex items-center gap-3 px-4 py-3 rounded-lg <?= $currentPage === 'dashboard' ? 'active' : '' ?>">
            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <a href="/dean/teacher_subjects.php" class="sidebar-link flex items-center gap-3 px-4 py-3 rounded-lg <?= $currentPage === 'teacher_subjects' ? 'active' : '' ?>">
            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <a href="/dean/reports.php" class="sidebar-link flex items-center gap-3 px-4 py-3 rounded-lg <?= $currentPage === 'reports' ? 'active' : '' ?>">
            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <a href="/dean/grade_approval.php" class="sidebar-link flex items-center gap-3 px-4 py-3 rounded-lg <?= $currentPage === 'grade_approval' ? 'active' : '' ?>">
            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <a href="/dean/profile.php" class="sidebar-link flex items-center gap-3 px-4 py-3 rounded-lg <?= $currentPage === 'profile' ? 'active' : '' ?>">
            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <div class="p-4 border-t border-neutral-800">
        <div class="flex items-center justify-between">
            <div class="flex items-center gap-3">
                ...
                <div>
                    <p class="text-sm font-medium"><?= $currentUser['name'] ?? 'Dean' ?></p>
