            ...
            <div class="lg:col-span-1">
                <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
                    <div class="bg-black p-8 text-center">
                        ...
                        <h2 class="text-xl font-bold text-white mt-4"><?= htmlspecialchars($admin['full_name'] ?? '') ?></h2>
                    ...
                    <div class="p-6">
                        <div class="space-y-4">
                            ...
                            <div class="flex items-center gap-3 text-gray-600">
                                ...
                                <span>Member since <?= formatDate($admin['member_since'] ?? date('Y-m-d')) ?></span>
                            </div>
                            <div class="flex items-center gap-3 text-gray-600">
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
                    ...
                    <form method="POST" class="space-y-4">
                        ...
                        <div>
                            ...
                            <input type="text" name="new_username" required minlength="3" value="<?= htmlspecialchars($admin['username'] ?? '') ?>"
